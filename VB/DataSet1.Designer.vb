...
Namespace dxKB3226
	...
	Partial Public Class DataSet1
		...
		Partial Public Class EmployeesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>
			Public Function AddEmployeesRow(ByVal CategoryID As Integer, ByVal Discontinued As Boolean, ByVal EAN13 As String, ByVal ProductName As String, ByVal QuantityPerUnit As String, ByVal ReorderLevel As Short, ByVal SupplierID As Integer, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal Discount As Single, ByVal OrderID As Integer, ByVal Expr1 As Integer, ByVal Quantity As Short, ByVal Expr2 As Decimal, ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal Freight As Decimal, ByVal OrderDate As Date, ByVal RequiredDate As Date, ByVal ShipAddress As String, ByVal ShipCity As String, ByVal ShipCountry As String, ByVal ShipName As String, ByVal ShippedDate As Date, ByVal ShipPostalCode As String, ByVal ShipRegion As String, ByVal ShipVia As Integer, ByVal Address As String, ByVal BirthDate As Date, ByVal City As String, ByVal Country As String, ByVal Extension As String, ByVal FirstName As String, ByVal HireDate As Date, ByVal HomePhone As String, ByVal LastName As String, ByVal Notes As String, ByVal Photo() As Byte, ByVal PostalCode As String, ByVal Region As String, ByVal ReportsTo As Integer, ByVal Title As String, ByVal TitleOfCourtesy As String, ByVal CategoryName As String, ByVal Description As String, ByVal Picture() As Byte, ByVal Expr6 As String, ByVal Expr7 As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Expr8 As String, ByVal Expr9 As String, ByVal Fax As String, ByVal Phone As String, ByVal Expr10 As String, ByVal Expr11 As String) As EmployeesRow
		...
		Partial Public Class EmployeesRow
			...
			Public Property CategoryID() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.CategoryIDColumn), Integer))
			...
			Public Property Discontinued() As Boolean
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.DiscontinuedColumn), Boolean))
					Catch e As Global.System.InvalidCastException
			...
			Public Property EAN13() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.EAN13Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ProductID() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ProductIDColumn), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ProductName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ProductNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property QuantityPerUnit() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.QuantityPerUnitColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ReorderLevel() As Short
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ReorderLevelColumn), Short))
					Catch e As Global.System.InvalidCastException
			...
			Public Property SupplierID() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.SupplierIDColumn), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property UnitPrice() As Decimal
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.UnitPriceColumn), Decimal))
					Catch e As Global.System.InvalidCastException
			...
			Public Property UnitsInStock() As Short
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.UnitsInStockColumn), Short))
					Catch e As Global.System.InvalidCastException
			...
			Public Property UnitsOnOrder() As Short
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.UnitsOnOrderColumn), Short))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Discount() As Single
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.DiscountColumn), Single))
					Catch e As Global.System.InvalidCastException
			...
			Public Property OrderID() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.OrderIDColumn), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr1() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr1Column), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Quantity() As Short
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.QuantityColumn), Short))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr2() As Decimal
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr2Column), Decimal))
					Catch e As Global.System.InvalidCastException
			...
			Public Property CustomerID() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.CustomerIDColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Freight() As Decimal
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.FreightColumn), Decimal))
					Catch e As Global.System.InvalidCastException
			...
			Public Property OrderDate() As Date
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.OrderDateColumn), Global.System.DateTime))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr3() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr3Column), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property RequiredDate() As Date
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.RequiredDateColumn), Global.System.DateTime))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipAddress() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipAddressColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipCity() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipCityColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipCountry() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipCountryColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShippedDate() As Date
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShippedDateColumn), Global.System.DateTime))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipPostalCode() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipPostalCodeColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipRegion() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipRegionColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ShipVia() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ShipViaColumn), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr4() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr4Column), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr5() As Integer
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr5Column), Integer))
					Catch e As Global.System.InvalidCastException
			...
			Public Property CategoryName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.CategoryNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Description() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.DescriptionColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Picture() As Byte()
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.PictureColumn), Byte()))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr6() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr6Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr7() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr7Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property CompanyName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.CompanyNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ContactName() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ContactNameColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property ContactTitle() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.ContactTitleColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr8() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr8Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr9() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr9Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Fax() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.FaxColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Phone() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.PhoneColumn), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr10() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr10Column), String))
					Catch e As Global.System.InvalidCastException
			...
			Public Property Expr11() As String
				Get
					Try
						Return (DirectCast(Me(Me.tableEmployees.Expr11Column), String))
					Catch e As Global.System.InvalidCastException
